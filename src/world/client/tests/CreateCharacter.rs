ClientMessage::CreateCharacter(
	CreateCharacter {
		data: lnv! {
			...
			"legoclub": false,
			"levelid": 1000i64,
			"position.z": -47.223167f32,
			"rotation.y": 0.733435f32,
			"position.x": -627.1862f32,
			"accountID": 1267289i64,
			"rotation.x": 0.0f32,
			"rotation.w": 0.6797596f32,
			"name": "FeralRunningSidekick",
			"propertycloneid": 2281687i32,
			"freetrial": true,
			"gmlevel": 0i32,
			"rotation.z": 0.0f32,
			"reputation": 0i64,
